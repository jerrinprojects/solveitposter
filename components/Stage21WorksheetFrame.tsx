...
import {
  Stage21Page, buildStage21Pages, WorksheetVersion,
...
export default function Stage21WorksheetFrame({ version }: { version: WorksheetVersion }) {
  const { page1, page2 } = buildStage21Pages(version);
    ...
    <>
      ...
      <main style={{ background: "#fff3e6", minHeight: "100vh", paddingBottom: 48 }}>
        ...
        <Page>
          ...
          <PosterFooter rightLabel={`Multiplication · Stage 2.1 · ${versionLabel} · Page 1`} />
        </Page>
        ...
        <Page>
          ...
          <PosterFooter rightLabel={`Multiplication · Stage 2.1 · ${versionLabel} · Page 2`} />
        </Page>
        ...
        <Page>
          ...
          <PosterFooter rightLabel={`Multiplication · Stage 2.1 · ${versionLabel} · Page 1 Answers`} />
        </Page>
        ...
        <Page>
          ...
          <PosterFooter rightLabel={`Multiplication · Stage 2.1 · ${versionLabel} · Page 2 Answers`} />
        </Page>
