...
import { TIME_PREVIEW_MAP } from "./TimePreview";
import ImageCard from "./ImageCard";

interface TimeSectionBlockProps {
  skill: PosterSkill;
}

export default function TimeSectionBlock({ skill }: TimeSectionBlockProps) {
  const PreviewComponent = TIME_PREVIEW_MAP[skill.code];
