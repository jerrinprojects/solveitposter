...
import { TEMPERATURE_PREVIEW_MAP } from "./TemperaturePreview";
import ImageCard from "./ImageCard";

interface TemperatureSectionBlockProps {
  skill: PosterSkill;
}

export default function TemperatureSectionBlock({ skill }: TemperatureSectionBlockProps) {
  const PreviewComponent = TEMPERATURE_PREVIEW_MAP[skill.code];
