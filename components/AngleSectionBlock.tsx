...
import { ANGLE_PREVIEW_MAP } from "./AnglePreview";
import ImageCard from "./ImageCard";

interface AngleSectionBlockProps {
  skill: PosterSkill;
}

export default function AngleSectionBlock({ skill }: AngleSectionBlockProps) {
  const PreviewComponent = ANGLE_PREVIEW_MAP[skill.code];
