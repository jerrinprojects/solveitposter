...
import { MASS_PREVIEW_MAP } from "./MassPreview";
import ImageCard from "./ImageCard";

interface MassSectionBlockProps {
  skill: PosterSkill;
}

export default function MassSectionBlock({ skill }: MassSectionBlockProps) {
  const PreviewComponent = MASS_PREVIEW_MAP[skill.code];
