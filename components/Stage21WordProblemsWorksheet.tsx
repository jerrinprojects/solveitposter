...
const SUBTRACTION_TEMPLATES: Array<(a: number, b: number) => string> = [
  ...
  (a, b) => `A garden has ${a} flowers. ${b} ${pl(b, "is", "are")} picked for a bouquet. How many flowers remain?`,
  (a, b) => `A jar has ${a} jellybeans. ${b} ${pl(b, "is", "are")} eaten. How many jellybeans are left?`,
  (a, b) => `An orchard has ${a} kiwifruit. ${b} ${pl(b, "is", "are")} picked. How many kiwifruit remain?`,
  (a, b) => `Lucas counted ${a} steps. He took ${b} ${pl(b, "step")} back. How many steps forward is he?`,
  ...
  (a, b) => `A hall has ${a} chairs. ${b} ${pl(b, "is", "are")} taken outside. How many chairs are left in the hall?`,
  ...
  (a, b) => `Ava ran ${a} laps. ${b} ${pl(b, "was", "were")} warm-up. How many were the main run?`,
  (a, b) => `A school van had ${a} bags. ${b} ${pl(b, "is", "are")} unloaded. How many bags are still on the van?`,
  (a, b) => `A box has ${a} marbles. ${b} ${pl(b, "is", "are")} taken out. How many marbles are still in the box?`,
