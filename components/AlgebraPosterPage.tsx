...
export default function AlgebraPosterPage({ meta, skills, footer, pageSizes }: Props) {
  return (
    <main className="bg-pink-100">
      ...
      <AlgebraYearSection meta={meta} skills={skills} footer={footer} pageSizes={pageSizes} />
      <PrintButton />
    </main>
  );
}
