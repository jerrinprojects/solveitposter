import DecimalPvYearSection from "@/components/DecimalPvYearSection";
...
export default function DecimalPvPosterPage({ meta, skills, footer, pageSizes }: Props) {
  return (
    <main className="bg-pink-100">
      ...
      <DecimalPvYearSection meta={meta} skills={skills} footer={footer} pageSizes={pageSizes} />
      <PrintButton />
    </main>
  );
}
