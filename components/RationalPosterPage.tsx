...
export default function RationalPosterPage({ meta, skills, footer, pageSizes }: Props) {
  return (
    <main className="bg-pink-100">
      ...
      <RationalYearSection meta={meta} skills={skills} footer={footer} pageSizes={pageSizes} />
      <PrintButton />
    </main>
  );
}
