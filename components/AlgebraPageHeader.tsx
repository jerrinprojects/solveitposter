...
/* Pink-themed Algebra header, mirrors the YearOps/Rational/NumberStructures
 * banner with Solvie mascot at the bottom-right corner. */
export default function AlgebraPageHeader({ meta }: Props) {
  return (
