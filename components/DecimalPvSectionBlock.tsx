...
import DecimalPvExercisePreview, {
  HAS_DECIMAL_PV_PREVIEW,
} from "./DecimalPvExercisePreview";
import ImageCard from "./ImageCard";

interface Props { skill: PosterSkill; }

export default function DecimalPvSectionBlock({ skill }: Props) {
  const hasPreview = HAS_DECIMAL_PV_PREVIEW.has(skill.code);
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 print-card">
      ...
      {skill.imageUrl ? (
        ...
        <DecimalPvExercisePreview code={skill.code} />
      ) : (
