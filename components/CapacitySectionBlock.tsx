...
import { CAPACITY_PREVIEW_MAP } from "./CapacityPreview";
import ImageCard from "./ImageCard";

interface CapacitySectionBlockProps {
  skill: PosterSkill;
}

export default function CapacitySectionBlock({ skill }: CapacitySectionBlockProps) {
  const PreviewComponent = CAPACITY_PREVIEW_MAP[skill.code];
