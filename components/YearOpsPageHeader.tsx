...
/* Pink-themed header for Year Operations posters. Uses the same Solvie
 * mascot as Number Structures (single line title fits easily). */
export default function YearOpsPageHeader({ meta }: Props) {
  return (
