...
export const posterSkills: PosterSkill[] = [
  ...
  { code: "5.2a", description: "I can identify the digit in the hundred thousands place." },
  { code: "5.3a", description: "I can work out how many ten thousands are in a given number." },
  ...
  { code: "5.9a", description: "I can round a number to the nearest ten thousand." },
];
